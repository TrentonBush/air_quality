...
class SenseairS8:
    ...
    def _serial_read(self, command: bytes, sleep_ms=180, n_bytes=7) -> bytes:
        self._ser.flushInput()
    ...
    def read_error_codes(self) -> None:
    ...
    def configure_abc(self, period_hours: Optional[int] = None, disable=False, recalibrate=False) -> None:
